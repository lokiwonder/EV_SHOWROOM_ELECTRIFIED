...
fn auto_start() {
  ...
  // regkey.set_value("EV CMS", &Data::String(r"C:\Users\lacls\Documents\Programing\ev_cms\src-tauri\target\debug\EV SHOWROOM Electrified.exe".try_into().unwrap())).unwrap();
}
